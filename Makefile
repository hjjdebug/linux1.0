...
CFLAGS = -Wall -Wstrict-prototypes -g3 -O2 -fomit-frame-pointer -pipe -fno-stack-protector
CFLAGS_G = -Wall -Wstrict-prototypes -g3  -fomit-frame-pointer -pipe -fno-stack-protector
PROFILING = -fno-builtin
...
AS	=as --32
LD	=ld -m elf_i386
HOSTCC	=gcc -I${PWD}/include
CC	=gcc -D__KERNEL__ -m32 -I${PWD}/include
MAKE	=make
CPP	=$(CC) -E
AR	=ar
STRIP	=strip
...
zImage: $(CONFIGURE) boot/bootsect boot/setup zBoot/zSystem tools/build
	...
	tools/build boot/bootsect boot/setup tools/kernel > zImage
	rm tools/kernel -f
...
qemu_run:
	qemu -m 16M -boot a -fda zImage -hda $(HDA_IMG)

qemu_debug:
	qemu -m 16M -boot a -fda zImage -hda $(HDA_IMG) -s -S 

run:
	bochs -q -f tools/bochs/bochsrc/bochsrc-hd-dbg.bxrc1	
debug:
